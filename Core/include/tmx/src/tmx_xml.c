...
static void
error_handler(void *arg UNUSED, const char *msg, xmlParserSeverities severity, xmlTextReaderLocatorPtr locator)
{
...
static int parse_property(xmlTextReaderPtr reader, tmx_property *prop)
{
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "name")))
    { /* name */
        prop->name = value;
    } else
    {
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "type")))
    { /* type */
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "value")))
    { /* source */
        switch (prop->type)
        {
            case PT_INT:
...
static int parse_points(xmlTextReaderPtr reader, double ***ptsarrayadr, int *ptslenadr)
{
    ...
    if (!(value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "points")))
    { /* points */
...
static int parse_object(xmlTextReaderPtr reader, tmx_object *obj)
{
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "x")))
    { /* x */
        obj->x = atof(value);
        tmx_free_func(value);
    } else
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "y")))
    { /* y */
        obj->y = atof(value);
        tmx_free_func(value);
    } else
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "visible")))
    { /* visible */
        obj->visible = (char) atoi(value);
        tmx_free_func(value);
    }

    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "height")))
    { /* height */
        obj->shape = S_SQUARE;
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "width")))
    { /* width */
        obj->width = atof(value);
        tmx_free_func(value);
    }

    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "gid")))
    { /* gid */
        obj->shape = S_TILE;
        obj->gid = atoi(value);
        tmx_free_func(value);
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "rotation")))
    { /* rotation */
...
static int parse_data(xmlTextReaderPtr reader, int32_t **gidsadr, size_t gidscount)
{
    ...
    if (!(value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "encoding")))
    { /* encoding */
    ...
    {
        tmx_free_func(value);
        if (!(value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "compression")))
        { /* compression */
...
static int parse_image(xmlTextReaderPtr reader, tmx_image **img_adr, short strict, const char *filename)
{
    ...
    *img_adr = res;
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "source")))
    { /* source */
        res->source = value;
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "trans")))
    { /* trans */
...
static int
parse_layer(xmlTextReaderPtr reader, tmx_layer **layer_headadr, int map_h, int map_w, enum tmx_layer_type type,
            const char *filename)
{
    tmx_layer *res;
    tmx_object *obj;
    ...
    *layer_headadr = res;
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "opacity")))
    { /* opacity */
        res->opacity = atof(value);
        tmx_free_func(value);
    }

    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "offsetx")))
    { /* offsetx */
        res->offsetx = (int) atoi(value);
        tmx_free_func(value);
    }

    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "offsety")))
    { /* offsety */
    ...
    if (type == L_OBJGR)
    {
        ...
        if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "color")))
        { /* color */
...
static tmx_anim_frame *parse_animation(xmlTextReaderPtr reader, int frame_count, unsigned int *length)
{
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "tileid")))
    { /* tileid */
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "duration")))
    { /* duration */
...
static int parse_tile(xmlTextReaderPtr reader, tmx_tileset *tileset, const char *filename)
{
    ...
    { /* id */
        ...
        if (to_move > 0)
        {
            memmove((tileset->tiles) + (len - to_move + 1), (tileset->tiles) + (len - to_move),
                    to_move * sizeof(tmx_tile));
        }
...
static int parse_tileset_sub(xmlTextReaderPtr reader, tmx_tileset *ts_addr, const char *filename)
{
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "tilecount")))
    { /* tilecount */
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "tilewidth")))
    { /* tile_width */
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "tileheight")))
    { /* tile_height */
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "spacing")))
    { /* spacing */
        ts_addr->spacing = atoi(value);
        tmx_free_func(value);
    }

    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "margin")))
    { /* margin */
...
static int parse_tileset(xmlTextReaderPtr reader, tmx_tileset **ts_headadr, const char *filename)
{
    ...
    *ts_headadr = res;
    ...
    /* parses each attribute */
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "firstgid")))
    { /* fisrtgid */
...
static tmx_map *parse_root_map(xmlTextReaderPtr reader, const char *filename)
{
    ...
    /* parses each attribute */
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "orientation")))
    { /* orientation */
    ...
    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "backgroundcolor")))
    { /* backgroundcolor */
        res->backgroundcolor = get_color_rgb(value);
        tmx_free_func(value);
    }

    if ((value = (char *) xmlTextReaderGetAttribute(reader, (xmlChar *) "hexsidelength")))
    { /* hexsidelength */
...
tmx_map *parse_xml(const char *filename)
{
    ...
    xmlMemSetup((xmlFreeFunc) tmx_free_func, (xmlMallocFunc) tmx_malloc, (xmlReallocFunc) tmx_alloc_func,
